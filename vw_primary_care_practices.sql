...
--FINAL RESULTS
SELECT 
   COALESCE(pac_id, group_practice_pac_id) AS practice_pac_id,
   practice_type,
   pac_id,
   full_name,
   group_practice_pac_id,
